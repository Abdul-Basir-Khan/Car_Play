...
class StationFullScreen extends StatefulWidget {
  const StationFullScreen({Key? key}) : super(key: key);

  @override
  State<StationFullScreen> createState() => _StationFullScreenState();
}

class _StationFullScreenState extends State<StationFullScreen> {
  @override
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                InkWell(
                  onTap:(){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> MapNavigate()));
                  },
                ...
                InkWell(
                  onTap:(){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>MapChargeStart() ));
                  },
                  child : Container(height: 64,
                    width: 289,
                    decoration: BoxDecoration(
